...
public class JoinServiceTest {
    ...
    @Test
    @DisplayName("필수 입력항목(이메일, 비밀번호, 비밀번호 확인, 회원명, 약관 동의) 검증, 검증 실패시 AlertException 발생")
    ...
    @Test
    @DisplayName("비밀번호와 확인이 일치하지 않으면 AlertException 발생")
    ...
    @Test
    @DisplayName("이메일이 형식에 맞지 않으면 AlertException 발생")
